        ...
        for opt_iter in range(args.noise_opt_steps):
            ...
            if args.use_amp:
                ...
                if torch.isfinite(loss_total):
                    ...
                    # Gradient clipping
                    torch.nn.utils.clip_grad_norm_([latent_noise], max_norm=1.0)
            ...
            if opt_iter % 1 == 0:
                ...
                mlflow.log_metrics({
                    ...
                    "loss_mohe_reg": loss_mohe_reg.item(),
            ...
            del z0t_hat, loss_ir, loss_mohe_reg, loss_jb_v, loss_ks_v, loss_total
